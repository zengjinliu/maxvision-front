        ...
        >
          <template slot-scope="scope">
            <el-button
              ...
              size="mini"
              v-if="HasPerms('sys_menu_add')"
              @click="addOrUpdate(scope.row.id, 'add')"
              >添加</el-button
            >
            <el-button
              type="info"
              size="mini"
              v-if="HasPerms('sys_menu_update')"
              @click="addOrUpdate(scope.row.id, 'edit')"
              >修改</el-button
            >
            <el-button
              type="danger"
              size="mini"
              v-if="HasPerms('sys_menu_del')"
